...
grep -q -F 'cd /opt/gopath/src/github.com/netapp/terraform-provider-netapp-gcp' /home/vagrant/.bashrc || cat >>/home/vagrant/.bashrc <<EOF

## After login, change to terraform-provider-netapp-gcp directory
cd /opt/gopath/src/github.com/netapp/terraform-provider-netapp-gcp
EOF
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.synced_folder '.', '/opt/gopath/src/github.com/netapp/terraform-provider-netapp-gcp'
